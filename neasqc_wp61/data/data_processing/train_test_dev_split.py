...
def main():
    ...
    if True:
        ...
        traindataset.to_csv(f"{namenoext}_train.tsv", sep='\t', mode='w',encoding='utf-8',index=False,header=False,columns=['Class','Txt'])
        testdataset.to_csv(f"{namenoext}_test.tsv", sep='\t', mode='w',encoding='utf-8',index=False,header=False,columns=['Class','Txt'])
        devdataset.to_csv(f"{namenoext}_dev.tsv", sep='\t', mode='w',encoding='utf-8',index=False,header=False,columns=['Class','Txt'])
