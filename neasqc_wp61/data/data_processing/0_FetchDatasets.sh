...
python -c "from zipfile import PyZipFile; PyZipFile('amazon-fine-food-reviews.zip', mode='r').extract('Reviews.csv', path='../datasets/')"
rm amazon-fine-food-reviews.zip

$HOME/.local/bin/kaggle datasets download kotartemiy/topic-labeled-news-dataset
python -c "from zipfile import PyZipFile; PyZipFile('topic-labeled-news-dataset.zip', mode='r').extract('labelled_newscatcher_dataset.csv', path='../datasets/')"
...
python -c "from zipfile import PyZipFile; PyZipFile('food-com-recipes-and-user-interactions.zip', mode='r').extract('RAW_interactions.csv', path='../datasets/')"
rm food-com-recipes-and-user-interactions.zip

$HOME/.local/bin/kaggle datasets download kritanjalijain/amazon-reviews
python -c "from zipfile import PyZipFile; PyZipFile('amazon-reviews.zip', mode='r').extract('train.csv', path='../datasets/')"
